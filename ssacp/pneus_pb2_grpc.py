...
class PneuStorageStub(object):
    """O serviço que o SSACP vai oferecer
    """
...
class PneuStorageServicer(object):
    """O serviço que o SSACP vai oferecer
    """
...
def add_PneuStorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pneus.PneuStorage', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pneus.PneuStorage', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class PneuStorage(object):
    """O serviço que o SSACP vai oferecer
    """
